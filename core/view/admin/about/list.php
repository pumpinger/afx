...
<div class="content_box">
    ...
    <a class="x-button x-button-serious" href="<?php echo adminU('about', 'edit') ?>">新增板块</a>
        ...
        <?php foreach ($this->data as $v): ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="x-button x-button-warning ajax-del" data-url="<?php echo adminU('about', 'del',array(
                        'id'=>$v['id']
                    )) ?>"> 删除</a>
                </td>
            </tr>
