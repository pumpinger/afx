...
<a class="x-button x-button-serious" href="<?php echo adminU('contact', 'list') ?>">返回列表</a>
    ...
    $('.submit').click(function (){
        xFormSubmit({
            ...
            success:function (data){
                ...
                if(json.ok){
                    window.location.href = '<?php echo adminU('contact', 'list')?>';
                }
            },
            url:'<?php echo adminU('contact','save')?>'
        });
    });
